...
export const teachersContent = {
  ...
  headlineLines: [
    "Learn from teachers who",
    "care about every child's growth.",
  ],
  description:
    "Our educators bring seasoned pedagogical craft, continuous child-development training, and genuine warmth. Homeroom teachers stay with each section across the year, ensuring every student is known, encouraged, and supported at every turn.",
